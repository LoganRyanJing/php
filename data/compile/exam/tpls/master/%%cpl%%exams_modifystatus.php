				...
				<div class="box itembox" style="padding-top:10px;margin-bottom:0px;">
					...
					<form action="index.php?exam-master-exams-modifystatus" method="post" class="form-horizontal" style="padding-top:10px;margin-bottom:0px;">
						<div class="form-group">
							...
							<div class="col-sm-6">
								<input id="examname" class="form-control" name="args[exam]" type="text" value="<?php echo $this->tpl_var['exam']['exam']; ?>" needle="needle" msg="您必须输入试卷名称" />
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-sm-10">
								<label class="radio-inline">
									<input name="args[examstatus]" type="radio" value="1" <?php if($this->tpl_var['exam']['examstatus']){ ?>checked<?php } ?>/>开启
								</label>
								<label class="radio-inline">
									<input name="args[examstatus]" type="radio" value="0" <?php if(!$this->tpl_var['exam']['examstatus']){ ?>checked<?php } ?>/>禁用
								</label>
							</div>
						</div>
						<!-- <div class="form-group">
						    		...
						    		<div class="qq-uploader-selector" style="width:27%" qq-drop-area-text="可将图片拖拽至此处上传" style="clear:both;">
						            	<div class="qq-upload-button-selector" style="clear:both;">
								            ...
								            <ul class="qq-upload-list-selector list-unstyled" aria-live="polite" aria-relevant="additions removals" style="clear:both;">
									            <li class="text-center">
									                <div class="thumbnail">
														<img class="qq-thumbnail-selector" src="<?php if($this->tpl_var['app']['appthumb']){ ?><?php echo $this->tpl_var['app']['appthumb']; ?><?php } else { ?>app/core/styles/images/noimage.gif<?php } ?>" alt="点击上传新图片">
														<input type="hidden" class="qq-edit-filename-selector" name="args[appthumb]" tabindex="0" value="<?php if($this->tpl_var['app']['appthumb']){ ?><?php echo $this->tpl_var['app']['appthumb']; ?><?php } else { ?>app/core/styles/images/noimage.gif<?php } ?>">
						                			</div>
									            </li>
									        </ul>
						                </div>
