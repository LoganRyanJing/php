...
{x2;endif}
				...
				<div class="box itembox" style="padding-top:10px;margin-bottom:0px;">
					...
					<form action="index.php?exam-master-score" method="post">
			        ...
			        <table class="table table-hover table-bordered">
			            ...
			            <tbody>
					        ...
					        <tr>
								...
								<td>
									<div class="btn-group">
										<a class="btn" href="index.php?exam-master-score-scorelist&page={x2;$page}&basicid={x2;v:basic['basicid']}{x2;$u}" title="成绩统计"><em class="glyphicon glyphicon-subscript"></em></a>
										<a class="btn" href="index.php?exam-master-score-exams&page={x2;$page}&basicid={x2;v:basic['basicid']}{x2;$u}" title="主观题批改"><em class="glyphicon glyphicon-saved"></em></a>
									</div>
								</td>
					        </tr>
					        {x2;endtree}
