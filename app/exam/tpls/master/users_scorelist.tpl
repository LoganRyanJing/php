...
{x2;endif}
				<div class="box itembox" style="margin-bottom:0px;border-bottom:1px solid #CCCCCC;">
					<div class="col-xs-12">
						<ol class="breadcrumb">
							...
							<li><a href="index.php?{x2;$_app}-master-score">课程成绩</a></li>
				...
				<div class="box itembox" style="padding-top:10px;margin-bottom:0px;">
					<h4 class="title" style="padding:10px;">
						成绩统计
						<a class="ajax pull-right btn btn-primary" href="index.php?{x2;$_app}-master-score-outscore&basicid={x2;$basicid}{x2;$u}">导出成绩</a>
					</h4>
					<form action="index.php?exam-master-score-scorelist&basicid={x2;$basicid}" method="post">
						<table class="table form-inline">
					        ...
					        <tr>
								...
								<td><button class="btn btn-primary" type="submit">提交</button> <a class="btn btn-primary" href="index.php?exam-master-score-stats&basicid={x2;$basicid}{x2;$u}">统计</a></td>
					        </tr>
						</table>
						<div class="input">
			        ...
			        <table class="table table-hover table-bordered">
			            ...
			            <tbody>
					        ...
					        <tr>
								...
								<td><a class="btn btn-primary" href="index.php?exam-master-score-readpaper&ehid={x2;v:exam['ehid']}" target="_blank">阅卷</a>&nbsp;<a class="btn btn-primary hide" href="index.php?exam-teach-users-changescore&ehid={x2;v:exam['ehid']}" target="_blank">纠分</a></td>
					        </tr>
					        {x2;endtree}
			        	</tbody>
			        </table>
